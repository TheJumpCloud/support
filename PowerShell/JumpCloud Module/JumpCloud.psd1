...
@{
    ...
    'New-JCImportTemplate', 'New-JCMSPImportTemplate', 'New-JCPolicy', 'New-JCRadiusServer',
    ...
    'Get-JCEvent', 'Get-JCEventCount', 'Update-JCMSPFromCSV', 'Import-JCMSPFromCSV'
    ...
    HelpInfoURI       = '//giom/TheJumpCloud/support/wiki'
