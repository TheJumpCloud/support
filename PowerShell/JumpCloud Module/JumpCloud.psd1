...
RequiredModules = @(@{ModuleName = 'JumpCloud.SDK.DirectoryInsights'; ModuleVersion = '0.0.8'; }, 
               @{ModuleName = 'JumpCloud.SDK.V1'; ModuleVersion = '0.0.14'; }, 
               @{ModuleName = 'JumpCloud.SDK.V2'; ModuleVersion = '0.0.19'; })
