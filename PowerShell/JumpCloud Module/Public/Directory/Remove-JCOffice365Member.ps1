function Remove-JCOffice365Member () {
    ...
    process {
        ...
        if ($Username -or $UserID) {
            ...
            $resultsArray = Set-JcSdkOffice365Association -Office365Id $CloudDirectory.Id -Op 'remove' -Type 'user' -Id $UserID
        } else {
            if ($GroupName) {
            ...
            $resultsArray = Set-JcSdkOffice365Association -Office365Id $CloudDirectory.Id -Op 'remove'  -Type 'user_group' -Id $GroupID
        }
    }
    end {
        return $resultsArray
