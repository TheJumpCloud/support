...

    {
...

        {
            ...
            while (($resultsArray).Count -ge $skip)
            {
                ...
                $results = Invoke-RestMethod -Method GET -Uri $limitURL -Headers $hdrs -UserAgent 'Pwsh_1.8.0'
...

        {
            foreach ($uid in $CommandID)
            {
                ...
                Write-Debug $URL
                $CommandResults = Invoke-RestMethod -Method GET -Uri $URL -Headers $hdrs -UserAgent 'Pwsh_1.8.0'
