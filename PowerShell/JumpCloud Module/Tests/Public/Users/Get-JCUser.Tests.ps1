...
Describe -Tag:('JCUser') 'Get-JCUser 1.1' {
    ...
    It "Searches a JumpCloud user by username" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -username $Username
    ...
    It "Searches a JumpCloud user by lastname" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -lastname $lastname
    ...
    It "Searches a JumpCloud user by firstname" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -firstname $firstname
    ...
    It "Searches a JumpCloud user by email" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -email $email
    ...
    It "Searches a JumpCloud user by alternateEmail" -Skip {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -alternateEmail $alternateEmail
    ...
    It "Searches a JumpCloud user by recoveryEmail" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -recoveryEmail $recoveryEmail
    ...
    It "Searches a JumpCloud user by managedAppleID" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -managedAppleID $managedAppleID
    ...
    It "Searches a JumpCloud user by managerID" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -manager $manager
    ...
    It "Searches a JumpCloud user by managerUsername" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -manager $managerUsername
    ...
    It "Searches a JumpCloud user by managerUsername & Email and should not return user with similar username" {
        ...
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -manager $newUser2.username
    ...
    It "Searches a JumpCloud user by managerEmail" {
        ...
        $managerId = $PesterParams_User1.id
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser -manager $managerEmail
    ...
    It "Searches a JumpCloud user by state SUSPENDED" {
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JcUser -state "SUSPENDED"
    ...
    It "Searches a JumpCloud user by state STAGED" {
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JcUser -state "STAGED"
    ...
    It "Searches a JumpCloud user by state ACTIVATED" {
        $NewUser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JcUser -state "ACTIVATED"
...
Describe -Tag:('JCUser') "Get-JCUser 1.12" {
    ...
    It "Searches for a user by external_source_type" {
        ...
        $Newuser = New-RandomUser -Domain "delGetUser.$(New-RandomString -NumberOfChars 5)" | New-JCUser
        $Random1 = "$(Get-Random)\+?|{[()^$.#"
        $Random2 = "$(Get-Random)\+?|{[()^$.#"
...
Describe -Tag:('JCUser') "Case Insensitivity Tests" {
    ...
    It "Searches params after setting values to include special characters like \|{[()^$.#" {
        ...
        $NewUser = "New-RandomUser -Domain `"delGetUser.$(New-RandomString -NumberOfChars 5)`" | New-JCUser @splat"
