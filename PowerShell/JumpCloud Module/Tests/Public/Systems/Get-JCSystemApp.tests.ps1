Describe -Tag:('JCSystemApp') 'Get-JCSystemApp' {
    ...
    It "Tests that given a systemID, SoftwareName, an app is returned" {
        ...
        { Get-JCSystemApp -SystemID $windows._id -SoftwareName "Microsoft Edge" } | Should -Not -BeNullOrEmpty
        { Get-JCSystemApp -SystemID $linux._id -SoftwareName "firefox" } | Should -Not -BeNullOrEmpty
    }
    ...
    It "Tests for search given SystemOs and SoftwareName" {
        ...
        #Windows
        { Get-JCSystemApp -Search | Should -Throw }
        { Get-JCSystemApp -Search -SoftwareName "Microsoft Edge" -SystemID $windows.Id | Should -Not -Throw }
        ...
        #Linux
        { Get-JCSystemApp -Search | Should -Throw }
        { Get-JCSystemApp -Search -SoftwareName "firefox" -SystemID $linux.Id | Should -Not -Throw }
        ...
        # A null value version shouldn't be accepted
        { Get-JCSystemApp -Search -SoftwareName "firefox" -SystemOs "" | Should -Throw }
        # A null value version shouldn't be accepted
