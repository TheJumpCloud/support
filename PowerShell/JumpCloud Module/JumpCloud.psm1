...
$global:JcTypesMap = @{
    ...
    Application          = [PSCustomObject]@{Name = 'application'; Identifier_Id = 'id'; Identifier_Name = 'displayName'; };
    AuthenticationPolicy = [PSCustomObject]@{Name = 'authentication_policy'; Identifier_Id = 'id'; Identifier_Name = 'name'; };
    Command              = [PSCustomObject]@{Name = 'command'; Identifier_Id = 'id'; Identifier_Name = 'name'; };
    ...
    Organization         = [PSCustomObject]@{Name = 'organization'; Identifier_Id = 'id'; Identifier_Name = 'displayName'; };
    Policy               = [PSCustomObject]@{Name = 'policy'; Identifier_Id = 'id'; Identifier_Name = 'name'; };
    RadiusServer         = [PSCustomObject]@{Name = 'radius_server'; Identifier_Id = 'id'; Identifier_Name = 'name'; };
    SoftwareApp          = [PSCustomObject]@{Name = 'software_app'; Identifier_Id = 'id'; Identifier_Name = 'displayName'; };
    System               = [PSCustomObject]@{Name = 'system'; Identifier_Id = 'id'; Identifier_Name = 'displayName'; };
    SystemGroup          = [PSCustomObject]@{Name = 'system_group'; Identifier_Id = 'id'; Identifier_Name = 'name'; };
    User                 = [PSCustomObject]@{Name = 'user'; Identifier_Id = 'id'; Identifier_Name = 'username'; };
