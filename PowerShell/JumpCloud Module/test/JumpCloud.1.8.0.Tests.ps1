...
Describe "Import-JCUsersFromCSV" {
    It "Imports users from a CSV populated with telephony attributes" {
        ...
        $UserCSVImport = Import-JCUsersFromCSV -CSVFilePath ./ImportExample_telephonyAttributes1.8.0.csv -force
        $UserImportInfo = Import-Csv ./ImportExample_telephonyAttributes1.8.0.csv
    ...
    It "Imports users from a CSV populated with information attributes" {
        ...
        $UserCSVImport = Import-JCUsersFromCSV -CSVFilePath ./ImportExample_userInformationAttributes1.8.0.csv -force
        $UserImportInfo = Import-Csv ./ImportExample_userInformationAttributes1.8.0.csv
    ...
    It "Imports users from a CSV populated with user location attributes" {
        $UserCSVImport = Import-JCUsersFromCSV -CSVFilePath ./ImportExample_userLocationAttributes1.8.0.csv -force
        $UserImportInfo = Import-Csv ./ImportExample_userLocationAttributes1.8.0.csv
    ...
    It "Imports users from a CSV populated with telephony, location, and user information attributes" {
        ...
        $UserCSVImport = Import-JCUsersFromCSV -CSVFilePath ./ImportExample_allNewAttributes1.8.0.csv -force
        $UserImportInfo = Import-Csv ./ImportExample_allNewAttributes1.8.0.csv
    ...
    It "Imports users from a CSV populated with telephony, location, user information attributes, group additions, system binding, and custom attributes" {
        ...
        $UserCSVImport = Import-JCUsersFromCSV -CSVFilePath ./ImportExample_AllNewAttributesAndAllCustom1.8.0.csv -force
        $UserImportInfo = Import-Csv ./ImportExample_AllNewAttributesAndAllCustom1.8.0.csv
