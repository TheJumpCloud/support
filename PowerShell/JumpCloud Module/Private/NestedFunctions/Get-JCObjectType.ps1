Function Get-JCObjectType
{
    ...
    DynamicParam
    {
        ...
        $ObjectTypes += [PSCustomObject]@{'Category' = 'JumpCloud'; 'Singular' = 'application'; 'Plural' = 'applications'; 'Targets' = ('user_group'); 'Url' = '/api/applications'; 'Method' = 'GET'; 'ById' = '_id'; 'ByName' = 'displayName'; 'Paginate' = $true; 'SupportRegexFilter' = $false; 'Limit' = 100; } # Targets = ('user')
        $ObjectTypes += [PSCustomObject]@{'Category' = 'JumpCloud'; 'Singular' = 'radius_server'; 'Plural' = 'radiusservers'; 'Targets' = ('user_group'); 'Url' = '/api/radiusservers'; 'Method' = 'GET'; 'ById' = '_id'; 'ByName' = 'name'; 'Paginate' = $true; 'SupportRegexFilter' = $false; 'Limit' = 100; } # Targets = ('user')
        $ObjectTypes += [PSCustomObject]@{'Category' = 'JumpCloud'; 'Singular' = 'system_group'; 'Plural' = 'systemgroups'; 'Targets' = ('policy', 'user_group', 'command', 'system'); 'Url' = '/api/v2/systemgroups'; 'Method' = 'GET'; 'ById' = 'id'; 'ByName' = 'name'; 'Paginate' = $true; 'SupportRegexFilter' = $true; 'Limit' = 100; }# Targets = ('user')
        $ObjectTypes += [PSCustomObject]@{'Category' = 'JumpCloud'; 'Singular' = 'system'; 'Plural' = 'systems'; 'Targets' = ('policy', 'user', 'command', 'system_group'); 'Url' = '/api/systems'; 'Method' = 'GET'; 'ById' = '_id'; 'ByName' = 'displayName'; 'Paginate' = $true; 'SupportRegexFilter' = $true; 'Limit' = 100; } # Targets = ('user_group')
        $ObjectTypes += [PSCustomObject]@{'Category' = 'JumpCloud'; 'Singular' = 'user_group'; 'Plural' = 'usergroups'; 'Targets' = ('active_directory', 'application', 'g_suite', 'ldap_server', 'office_365', 'radius_server', 'system_group', 'user'); 'Url' = '/api/v2/usergroups'; 'Method' = 'GET'; 'ById' = 'id'; 'ByName' = 'name'; 'Paginate' = $true; 'SupportRegexFilter' = $true; 'Limit' = 100; } # Targets = ('system')
        $ObjectTypes += [PSCustomObject]@{'Category' = 'JumpCloud'; 'Singular' = 'user'; 'Plural' = 'users'; 'Targets' = ('active_directory', 'g_suite', 'ldap_server', 'office_365', 'system', 'user_group'); 'Url' = '/api/systemusers'; 'Method' = 'GET'; 'ById' = '_id'; 'ByName' = 'username'; 'Paginate' = $true; 'SupportRegexFilter' = $true; 'Limit' = 100; }# Targets = ('application','radius_server','system_group')
