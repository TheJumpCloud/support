...
Mac - Bind Logged in User to System | Prompt = Force, Permissions = Existing, Force Logout = True, Association Removal = systemGroup | JCCG v1.0
...
```
Import-JCCommand -URL 'https://git.io/fh2jI'
```
