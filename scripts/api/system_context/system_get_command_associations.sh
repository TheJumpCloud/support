...
signstr="GET /api/v2/systems/${systemKey}/associations?targets=command HTTP/1.1\ndate: ${now}"
...
curl -iq \
    ...
    --url https://console.jumpcloud.com/api/v2/systems/${systemKey}/associations?targets=command
