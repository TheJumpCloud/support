...
Invoke-RestMethod -Method GET -Uri "https://console.jumpcloud.com/api/v2/systems/$systemKey/associations?targets=command" -ContentType 'application/json' -Headers $headers
