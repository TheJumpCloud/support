...
$signstr = "GET /api/v2/systems/$systemKey/associations?targets=command HTTP/1.1`ndate: $now"
...
Invoke-WebRequest -Method GET -Uri "https://console.jumpcloud.com/api/v2/systems/$systemKey/associations?targets=command" -ContentType 'application/json' -Headers $headers