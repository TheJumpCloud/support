...
$signstr = "GET /api/v2/systems/$systemKey/users HTTP/1.1`ndate: $now"
...
Invoke-RestMethod -Method GET -Uri "https://console.jumpcloud.com/api/v2/systems/$($systemKey)/users" -ContentType 'application/json' -Headers $headers
